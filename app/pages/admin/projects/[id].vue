              ...
              <div :class="[...animations.cardClasses.value]" class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-50">
                  <div class="flex items-center justify-between">
                    ...
                    <button
                      v-if="canManageProjects"
                      disabled
                      class="flex items-center gap-2 px-4 py-2 bg-gray-400 text-white text-sm font-medium rounded-lg cursor-not-allowed opacity-60"
                      title="Coming soon"
                    >
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                ...
                <div class="p-6">
                  <div class="text-center py-16">
                    ...
                    <p class="text-sm text-gray-500 max-w-md mx-auto">Document management features are currently under development. You'll be able to upload, organize, and manage project documents here soon.</p>
                  </div>
                </div>
              </div>
            </div>
